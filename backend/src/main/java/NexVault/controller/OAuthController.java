...
import NexVault.service.OAuthService;
...
public class OAuthController {
    ...
    @Operation(summary = "Google OAuth2 callback — exchanges code for NexVault JWT")
    ...
    @Operation(summary = "Discord OAuth2 callback — exchanges code for NexVault JWT")
