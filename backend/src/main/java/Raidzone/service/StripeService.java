...
import Raidzone.dto.response.StripeIntentResponse;
import Raidzone.exception.ResourceNotFoundException;
import Raidzone.model.Order;
import Raidzone.model.Payment;
import Raidzone.model.PaymentProvider;
import Raidzone.model.PaymentStatus;
import Raidzone.repository.OrderRepository;
import Raidzone.repository.PaymentRepository;
...
public class StripeService {
    ...
    public StripeIntentResponse createPaymentIntent(UUID orderId, BigDecimal amountUSD, UUID userId) {
        ...
        try {
            ...
            PaymentIntentCreateParams params = PaymentIntentCreateParams.builder()
                    ...
                    .setDescription("Raidzone Order " + orderId)
                    ...
                    .setShipping(PaymentIntentCreateParams.Shipping.builder()
                            ...
                            .setAddress(PaymentIntentCreateParams.Shipping.Address.builder()
                                    ...
                                    .build())
                            .build())
                    .setStatementDescriptorSuffix("Raidzone")
    ...
    private String buildItemsHtml(Order order) {
        ...
        for (Raidzone.model.OrderItem item : order.getItems()) {
