...
import Raidzone.repository.EmailSubscriberRepository;
    ...
    public void sendCampaign(String subject, String htmlBody, boolean includeRegistered) {
        ...
        for (String email : recipients) {
            try {
                ...
                h.setFrom(fromAddress, "Raidzone");
                h.setTo(email);
                    ...
                    <table width="560" cellpadding="0" cellspacing="0"
                      ...
                      <tr>
                        <td style="background:linear-gradient(135deg,#7C3AED,#22D3EE);padding:28px 32px;text-align:center;">
                          <div style="font-size:26px;font-weight:800;color:#fff;">&#9670; Raidzone</div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding:20px 40px 32px;border-top:1px solid #1E1E2E;">
                          <p style="margin:0;font-size:12px;color:#4B5563;text-align:center;">
                            You are receiving this because you subscribed to Raidzone updates.<br/>
                            &copy; 2025 Raidzone. All rights reserved.
                          </p>
                        </td>
                      </tr>
                    </table>
